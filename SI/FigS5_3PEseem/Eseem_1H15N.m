...
%%%
clear all
Filename1 = 'A051019_N15Aer.dat';
Filename2 = 'A051019_N15Aer_Time.dat';
...
Sys.Nucs = '15N,15N';
Sys.A = [3.4	0.1 84.9;  3.3 2.9 36.7];
Sys.T1 = [4000];
Sys.T2 = [200];
 
Opt.GridSize = 10; % A lot of orientation are needed as the hfccs of the 14N/15N are strongly anisotropic
Opt.TimeDomain = 0 ; 
Opt.ProductRule = 0;
