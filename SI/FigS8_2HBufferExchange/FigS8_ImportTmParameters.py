...
import numpy as np
from ImportMultipleFiles_FigS8 import eprload, ImportMultipleNameFiles
from ImportMultipleFiles_FigS8 import MaxLengthOfFiles
...
folder = getcwd() + '\\RawData\\RelaxationTime\\Tm\\'
