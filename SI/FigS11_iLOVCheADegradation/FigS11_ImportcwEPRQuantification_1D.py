...
from ImportMultipleFiles_FigS11 import OpenDoubleIntegral
...
FirstDeriv, ZeroDeriv, Header, IntgValue, HeaderInt = OpenDoubleIntegral(
    ListOfFiles, Scaling=None, polyorder=[1, 1], window=200)
...
del figManager, fileID, folder, i, l1, l2, x, x2, y, y2, axes, fig
