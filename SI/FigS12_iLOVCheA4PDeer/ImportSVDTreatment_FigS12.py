...
# Initiate Variable:
timestackedvalue = [0.06, 0, 0.018, 0.037]
diststackedvalue = [12, 0, 4, 8]
color = ['k', 'b', 'g', 'r']
...
for i in range(len(Listoffilename)):
    ...
    nameline1 = 'l1{0}'.format(2*i)
    nameline2 = 'l1{0}'.format(2*i+1)
...
del font, header, i, axes2, color, diststackedvalue, fig2, folder3, nameline2
del l4, ncol, ncol2, npts, P1, P1_down, P1_up, r1, size, t1, TITL1, yfit
del y, y1, y1norm, yfit1, yfit1_norm, t, intgValue, nameline1, timestackedvalue
