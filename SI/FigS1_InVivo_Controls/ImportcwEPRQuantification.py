...
@author: tim_t
"""
from ImportMultipleFiles_FigS1 import ImportMultipleNameFiles
from ImportMultipleFiles_FigS1 import OpenDoubleIntegral
# import matplotlib.pyplot as plt
from os import path, makedirs, getcwd
folder = getcwd()
ListOfFiles = ImportMultipleNameFiles(folder, Extension='.DSC')
FirstDeriv, ZeroDeriv, Header, IntgValue, HeaderInt = OpenDoubleIntegral(
    ListOfFiles, Scaling=None, polyorder=[1, 1], window_length=200)

# If you wish an automatic plot of the files
