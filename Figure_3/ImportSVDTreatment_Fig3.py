...
# Initiate Variable:
timestackedvalue = [0.085, 0.065, 0]
diststackedvalue = [2, 1, 0]
color = ['k', 'g', 'b']
...
# Delete useless created variable
del axes, fig, figManager, fileID, filename, filenametest, folder1, folder2
del font, header, i, axes2, color, diststackedvalue, fig2, folder3
del l4, ncol, ncol2, npts, P1, P1_down, P1_up, r1, size, t1, TITL1, yfit
del y, y1, y1norm, yfit1, yfit1_norm, t, intgValue, nameline1, nameline2
del timestackedvalue
